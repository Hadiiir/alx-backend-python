"""
Unit tests for utils module with parameterization
"""
...
if __name__ == '__main__':
    ...
    # Add test cases
    suite.addTests(loader.loadTestsFromTestCase(TestAccessNestedMap))
    suite.addTests(loader.loadTestsFromTestCase(TestGetJson))
    suite.addTests(loader.loadTestsFromTestCase(TestMemoize))
